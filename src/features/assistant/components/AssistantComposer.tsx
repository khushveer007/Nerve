      ...
      <div className="rounded-3xl border border-border bg-card p-3 shadow-sm">
        <div className="flex items-end gap-3">
          <Textarea
            ...
            placeholder={disabled ? 'Assistant is busy connecting or retrieving results...' : 'Ask a trusted question about Nerve knowledge...'}
            ref={textareaRef}
            rows={2}
            value={value}
          />
        ...
        <div className="mt-3 flex flex-col gap-1 text-xs text-muted-foreground sm:flex-row sm:items-center sm:justify-between">
          <span>
            {disabled ? 'Wait for the current availability or retrieval step to finish.' : 'Enter to send. Shift+Enter for a new line.'}
          </span>
